...
public class bn {
     ...
     */
    public static void a(bn bn2, l l2, IniFile ab2, String string2) throws bo {
        Texture_M e2;
        Object object;
        Object object2;
        Float f2;
        ...
        Float f8 = Float.valueOf(ab2.i(string4, "x"));
        Float f9 = Float.valueOf(ab2.i(string4, "y"));
        String string5 = ab2.b(string4, "copyFrom", (String)null);
        if (string5 != null) {
            object3 = l2.e(string5);
            if (object3 == null) {
        ...
        bn2.f = f8.floatValue();
        bn2.g = f9.floatValue();
        bn2.h = ab2.a(string4, "height", Float.valueOf(0.0f)).floatValue();
        bn2.i = ab2.a(string4, "yAxisScaling", Float.valueOf(1.0f)).floatValue();
        object3 = ab2.b(string4, "linkDelayWithTurret", (String)null);
        if (object3 != null) {
            bn2.ao = l2.e((String)object3);
            if (bn2.ao == null) {
                throw new RuntimeException("[" + string2 + "] Could not find 'linkDelayWithTurret' turret target with name:" + (String)object3);
            }
            bn2.m = 9000.0f;
        }
        ...
        bn2.p = ab2.a(string4, "recoilOffset", Float.valueOf(bn2.p)).floatValue();
        bn2.q = ab2.a(string4, "recoilOutTime", Float.valueOf(bn2.q)).floatValue();
        bn2.r = ab2.b(string4, "recoilReturnTime", Float.valueOf(bn2.r)).floatValue();
        ...
        if (string6 != null) {
            object2 = l2.f(string6);
            if (object2 == null) {
                if (!"0".equals(string6) || l2.fT.size() != 1 || l2.f("1") == null) throw new RuntimeException("[" + string2 + "] Could not find projectile with name:" + string6);
                bn2.R = 0;
            } else {
                bn2.R = ((bh)object2).bi;
            }
        }
        if ((object2 = ab2.b(string4, "altProjectile", (String)null)) != null) {
            object = l2.f((String)object2);
            if (object == null) {
                throw new RuntimeException("[" + string2 + "]altProjectile: Could not find projectile with name:" + (String)object2);
            }
            bn2.S = ((bh)object).bi;
        }
        ...
        bn2.Q = ab2.a(string4, "canAttackMaxAngle", Float.valueOf(bn2.Q)).floatValue();
        bn2.U = ab2.a(string4, "turnSpeed", bn2.U);
        bn2.V = ab2.a(string4, "turnSpeedAcceleration", Float.valueOf(bn2.V)).floatValue();
        bn2.W = ab2.a(string4, "turnSpeedDeceleration", Float.valueOf(bn2.W)).floatValue();
        object = ab2.a(string4, "barrelY", (Float)null);
        ...
        bn2.Y = ab2.a(string4, "barrelX", Float.valueOf(bn2.Y)).floatValue();
        bn2.Z = ab2.a(string4, "barrelOffsetX_onOddShots", Float.valueOf(bn2.Z)).floatValue();
        bn2.aa = ab2.a(string4, "barrelHeight", Float.valueOf(bn2.aa)).floatValue();
        bn2.ab = ab2.a(string4, "limitingRange", Float.valueOf(bn2.ab)).floatValue();
        bn2.ai = ab2.a(string4, "limitingAngle", Float.valueOf(bn2.ai)).floatValue();
        bn2.ag = ab2.a(string4, "limitingMinRange", Float.valueOf(bn2.ag)).floatValue();
        bn2.af = ab2.a(string4, "aimOffsetSpread", Float.valueOf(bn2.af)).floatValue();
        if (bn2.ai >= 0.0f) {
            l2.bG = true;
        }
        ...
        if (bn2.ak != null) {
            l2.bF = true;
            l2.a(com.corrodinggames.rts.game.units.custom.b.k.a);
            bn2.al = ab2.a(string4, "interceptProjectiles_andTargetingGroundUnderDistance", Float.valueOf(bn2.al)).floatValue();
            bn2.am = ab2.a(string4, "interceptProjectiles_andUnderDistance", Float.valueOf(bn2.am)).floatValue();
            bn2.an = ab2.a(string4, "interceptProjectiles_andOverHeight", Float.valueOf(bn2.an)).floatValue();
        }
        bn2.aq = ab2.a(string4, "shouldResetTurret", (Boolean)bn2.aq);
        bn2.ar = ab2.a(string4, "idleSpin", Float.valueOf(bn2.ar)).floatValue();
        bn2.as = ab2.a(string4, "idleSweepAngle", Float.valueOf(bn2.as)).floatValue();
        bn2.at = ab2.a(string4, "idleSweepDelay", Float.valueOf(bn2.at)).floatValue();
        bn2.au = ab2.a(string4, "idleSweepSpeed", Float.valueOf(bn2.au)).floatValue();
        bn2.av = ab2.a(l2, string4, "idleSweepCondition", bn2.av);
        bn2.av = LogicBoolean.convertAlwaysTrueToNull(bn2.av);
        bn2.aw = ab2.a(string4, "idleSweepAddRandomDelay", Float.valueOf(bn2.aw)).floatValue();
        if (bn2.aw < 0.0f) {
            float f13 = 1.0f;
            if (bn2.at > 200.0f) {
                f13 = 20.0f;
        ...
        bn2.ax = ab2.a(string4, "idleSweepAddRandomAngle", Float.valueOf(bn2.ax)).floatValue();
        if (bn2.ax < 0.0f) {
        ...
        bn2.aB = ab2.b(string4, "onShoot_freezeBodyMovementFor", Float.valueOf(bn2.aB)).floatValue();
        ...
        bn2.aG = ab2.a(string4, "image_drawOffsetX", Float.valueOf(bn2.aG)).floatValue();
        bn2.aH = ab2.a(string4, "image_drawOffsetY", Float.valueOf(bn2.aH)).floatValue();
        Texture_M e3 = l2.a(ab2, string4, "chargeEffectImage");
        if (e3 != null) {
            bn2.aF = e3;
            l2.fP = true;
        }
