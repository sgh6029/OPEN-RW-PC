...
public class ba {
    ...
    public static void a(ba ba2, l l2, IniFile ab2, String string2, boolean bl2, ArrayList arrayList) {
        Float f2;
        Float f3;
        Boolean bl3;
        Boolean bl4;
        ...
        ba2.b = string2.replace("_", "");
        ba2.c = bl2;
        object = ab2.a(string2, "attach_x", (Float)null);
        if (object != null) {
        ...
        ba2.f = ab2.a(string2, "liftingHeightOffset", Float.valueOf(ba2.f)).floatValue();
        ba2.g = ab2.a(string2, "targetHeight", Float.valueOf(ba2.g)).floatValue();
        ba2.h = ab2.a(string2, "targetHeightRelative", (Boolean)ba2.h);
        ba2.i = ab2.a(string2, "endDirOffset", Float.valueOf(0.0f)).floatValue();
        ba2.l = ab2.a(string2, "lockMovement", (Boolean)ba2.l);
        ba2.m = ab2.a(string2, "estimatingPositionMultiplier", Float.valueOf(ba2.m)).floatValue();
        ba2.q = ab2.a(l2, string2, "hidden", ba2.q);
        ba2.p = ba2.q == LogicBoolean.trueBoolean;
        ba2.r = ab2.a(string2, "alpha", Float.valueOf(ba2.r)).floatValue();
        Float f5 = ab2.a(string2, "moveSpeed", (Float)null);
        if (f5 != null) {
            ba2.s = f5.floatValue();
        }
        ba2.t = ab2.b(string2, "moveWarmUp", Float.valueOf(ba2.t)).floatValue();
        ba2.u = ab2.a(string2, "rotateSpeed", Float.valueOf(ba2.u)).floatValue();
        Float f6 = ab2.a(string2, "resetAngle", (Float)null);
        if (f6 != null) {
            ba2.w = f6.floatValue();
        }
        boolean bl8 = ab2.a(string2, "image_end_teamColors", (Boolean)false);
        Texture_M e7 = l2.a(ab2, string2, "image_foot");
        if (e7 != null) {
            ba2.B = e7;
        ...
        ba2.R = ab2.a(string2, "drawDirOffset", Float.valueOf(ba2.R)).floatValue();
        ba2.T = ab2.a(string2, "spinRate", Float.valueOf(ba2.T)).floatValue();
    }
}
