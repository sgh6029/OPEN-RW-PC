...
public class d {
    ...
    public bb h;
    public aj i;
    public com.corrodinggames.rts.game.units.a.ActionType j = com.corrodinggames.rts.game.units.a.ActionType.popupQueue;
    public String k;
    public v l;
    public at[] m;
    public boolean n;
    ...
    public bl aw;
    public bl ax;
    public com.corrodinggames.rts.gameFramework.m.Texture_M ay;
    public com.corrodinggames.rts.gameFramework.m.Texture_M az;
    public int aA;
    ...
    public ActionDisplayType aG = com.corrodinggames.rts.game.units.a.ActionDisplayType.queueUnit;
    public LogicBoolean aH;
    public boolean aI;
    public int aJ;
    public boolean aK;
    public String aL;
    public f aM = com.corrodinggames.rts.game.units.custom.a.f.build;
    public e aN = com.corrodinggames.rts.game.units.custom.a.e.auto;
