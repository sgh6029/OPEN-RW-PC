...
extends a_f2 {
    ...
    public static void a(l l2, IniFile ab2, String string2, String string3, d d2, String string4, boolean bl2) throws bo {
        ...
        float f2 = ab2.a(string2, string3 + "takeResources_includeUnitsWithinRange", Float.valueOf(-1.0f)).floatValue();
        ...
        m2.e = (q)ab2.a(string2, "takeResources_includeUnitsWithinRange_team", com.corrodinggames.rts.game.q.own, q.class);
    ...
    public boolean a(j j2, AbstractUnitAction s2, PointF pointF, BaseUnit am2, int n2) {
        ...
        if (this.b) {
            ...
            while (((Iterator) object).hasNext()) {
                am4 = (BaseUnit)((Iterator) object).next();
        ...
        if (this.f != null && (object = this.f.readUnit(j2)) != null && !((BaseUnit)object).bV) {
            m2.add(object);
        }
        if (this.d > 0.0f) {
            ...
            ((com.corrodinggames.rts.gameFramework.GameEngine)object).cc.a(j2.posX, j2.posY, this.d, j2, 0.0f, u);
        }
        if (this.g != null) {
            for (int i2 = m2.size() - 1; i2 >= 0; --i2) {
                am4 = (BaseUnit)m2.get(i2);
        ...
        if (this.i != null) {
            for (int i4 = m2.size() - 1; i4 >= 0; --i4) {
                am4 = (BaseUnit)m2.get(i4);
                if (!this.i.b(am4)) continue;
                m2.remove(i4);
            }
        }
        if (this.j != null) {
            BaseUnit am5 = this.j.get(j2);
            for (int i5 = m2.size() - 1; i5 >= 0; --i5) {
                am3 = (BaseUnit)m2.get(i5);
        ...
        for (int i6 = 0; i6 < m2.size(); ++i6) {
            BaseUnit am6 = (BaseUnit)m2.get(i6);
            if (am3 == null) {
                am3 = am6;
            }
            if (this.s) {
            ...
            if (this.n != null && am6 != null) {
                PointF pointF2 = new PointF(am6.posX, am6.posY);
