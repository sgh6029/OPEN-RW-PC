...
public class VariableScope$VariableName {
    ...
    public static VariableScope$VariableName getExistingOrNull(String string2) {
        ...
        synchronized (hashMap) {
            VariableScope$VariableName variableScope$VariableName = (VariableScope$VariableName)existingVariableName.get(string2);
    ...
    public static VariableScope$VariableName get(String string2) {
        ...
        synchronized (hashMap) {
            ...
            existingVariableName.put(string2, variableScope$VariableName2);
