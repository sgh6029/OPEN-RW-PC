...
extends a {
    ...
    public void b(j j2, float f2) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            if (bn2.aj != null && j2.cB > 0.0f && !j2.v) {
                ...
                if (p.a((y)j2, k.b.x, k.b.b, j2.posZ, f4, f3)) {
                    // empty if block
                }
                if (j2.cB < 0.0f) {
                    j2.cB = 0.0f;
    ...
    public static void a(j j2, bn bn2) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            if (f8.aE == null || !(f8.posZ > f4) || !g.a(f8.aE, h2) || !((f7 = com.corrodinggames.rts.gameFramework.GameUtils.a(j2.posX, j2.posY, f8.posX, f8.posY)) < f3 * f3) || !((f6 = com.corrodinggames.rts.gameFramework.GameUtils.a(j2.posX, j2.posY, f8.n, f8.o)) < f2 * f2) && !(f2 < 0.0f) || f8.j != null && (f8.j.bX.d(j2.bX) || f8.j.bX == j2.bX) || f8.h <= 0.0f || k.a(f8)) continue;
            f5 = f8;
        }
        if (f5 != null) {
            j2.b(bn2);
            f f9 = j2.a(null, f5.posX, f5.posY, bn2.e, null, 0);
            f9.aC = true;
            f9.q = f5;
        }
    }
