...
extends UnitAction {
    ...
    public static UnitAction a(d d2) {
        boolean bl2 = false;
        ...
        if (!bl2) {
            return com.corrodinggames.rts.game.units.a.UnitAction.a;
        }
        c c2 = new c();
        c2.c = d2.z;
        c2.d = d2.A;
    ...
    public static UnitAction a(p p2) {
        boolean bl2 = false;
    ...
    public boolean a(BaseUnit am2, int n2) {
        if (this.c != null && (n2 == -1 || n2 == 1)) {
            if (!(am2 instanceof y)) {
                com.corrodinggames.rts.gameFramework.GameEngine.n("CustomActionConfig lockedInGame:" + am2.r().i() + " is not a OrderableUnit unit");
                return false;
            }
    ...
    public boolean a(BaseUnit am2, boolean bl2) {
        if (this.b != null) {
            if (!(am2 instanceof y)) {
                com.corrodinggames.rts.gameFramework.GameEngine.n("CustomActionConfig isAvailable:" + am2.r().i() + " is not a OrderableUnit unit");
                return true;
            }
            if (bl2) {
    ...
    public boolean d(BaseUnit am2) {
        if (this.j != null) {
            if (!(am2 instanceof y)) {
                com.corrodinggames.rts.gameFramework.GameEngine.n("CustomActionConfig isGuiBlinking:" + am2.r().i() + " is not a OrderableUnit unit");
                return true;
            }
