...
extends i {
    ...
    PointF f = new PointF();
    Rect g = new Rect();
    static AbstractUnitAction h = new q$1(142);
    static AbstractUnitAction i = new q$2(143);
    ...
    public static void b() {
        ...
        b = l2.bO.a(com.corrodinggames.rts.R.drawable.nuke_launcher_dead);
        com.corrodinggames.rts.gameFramework.m.Texture_M e2 = l2.bO.a(com.corrodinggames.rts.R.drawable.nuke_launcher);
        a = com.corrodinggames.rts.game.PlayerTeam.a(e2);
        e2.n();
        d = l2.bO.a(com.corrodinggames.rts.R.drawable.unit_icon_building);
        e = com.corrodinggames.rts.game.PlayerTeam.a(d);
    }
    ...
    public UnitTypeEnum K() {
        return com.corrodinggames.rts.game.units.UnitTypeEnum.NukeLaucher;
    }
    ...
    public void a(float f2, float f3) {
        ...
        float f4 = com.corrodinggames.rts.gameFramework.GameUtils.a(this.posX, this.posY, f2, f3);
        if (f4 < 202500.0f) {
            if (this.bX == l2.bs) {
        ...
        float f5 = 5.0f;
        f f6 = com.corrodinggames.rts.game.units.d.q.a((BaseUnit)this, pointF.x, pointF.b, f2, f3);
        f6.i = f5;
        com.corrodinggames.rts.gameFramework.effect.e e3 = l2.bR.a(pointF.x, pointF.b, this.posZ, -1127220);
        if (e3 != null) {
            e3.U = f5;
            e3.G = 2.1f;
            e3.F = 2.1f;
        ...
        if ((e2 = l2.bR.d(pointF.x, pointF.b, 0.0f, -1)) != null) {
            e2.G = 1.0f;
            e2.F = 3.1f;
            e2.ar = (short)2;
            e2.W = e2.V = 170.0f;
        ...
        float f7 = 0.8f;
        l2.bM.a(com.corrodinggames.rts.gameFramework.sound.e.D, 0.27f, f7, pointF.x, pointF.b);
    }

    public static f a(BaseUnit am2, float f2, float f3, float f4, float f5) {
        ...
        GameEngine l2 = GameEngine.getInstance();
        l2.bR.b(com.corrodinggames.rts.gameFramework.effect.h.critical);
        com.corrodinggames.rts.gameFramework.effect.e e2 = l2.bR.a(f6, -1118720);
        if (e2 != null) {
            e2.W = e2.V = 1300.0f;
            e2.E = 0.2f;
            e2.G = 1.0f;
    ...
    @Override
    public void a(AbstractUnitAction s2, boolean bl2, PointF pointF, BaseUnit am2) {
        if (bl2) {
            return;
        }
        if (s2 == h) {
            if (pointF == null) {
                com.corrodinggames.rts.gameFramework.j.NetworkEngine.g("action:" + h.N() + " needs point but it is missing");
                return;
            }
            this.a(pointF.x, pointF.b);
            return;
        }
        try {
    ...
    public void e(float f2) {
        ...
        com.corrodinggames.rts.gameFramework.utility.y.b((BaseUnit)this, 450.0f, false);
    }
