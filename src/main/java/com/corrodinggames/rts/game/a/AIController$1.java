...
class AIController$1
extends UnitBuildStrategy {
    final /* synthetic */ AIController a;

    AIController$1(AIController a2, String string2) {
        super(a2, string2);
        this.a = a2;
    }
    ...
    public boolean a(UnitType as2) {
        return com.corrodinggames.rts.game.a.AIController.a(this.a, as2) && this.a(as2, UnitMovementType.LAND);
    }
}
