...
class AIController$5
extends UnitBuildStrategy {
    final /* synthetic */ AIController a;

    AIController$5(AIController a2, String string2) {
        super(a2, string2);
        this.a = a2;
    }
    ...
    public boolean a(UnitType as2) {
        ...
        if (am2.bI()) {
            ...
            for (AbstractUnitAction s2 : tmp) {
                UnitType as3;
                PopupQueueAction w2;
                if (s2 == null || !(s2 instanceof PopupQueueAction) || (w2 = (PopupQueueAction)s2).F() || (as3 = w2.i()) == null || as3.j() || !as3.m()) continue;
                bl2 = true;
            }
            if (bl2) {
                return true;
