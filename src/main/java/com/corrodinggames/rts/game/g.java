...
public class g {
    ...
    public float a(BaseUnit am2, float f2, boolean bl2) {
    ...
    public static void a(g g2, GameOutputStream as2) throws IOException {
        if (g2 == a) {
            as2.c(0);
            return;
        }
        ...
        com.corrodinggames.rts.gameFramework.GameEngine.g("writeOutLink: Unhandled projectile type");
        as2.c(0);
    }

    public static g a(GameInputStream k2) throws IOException {
        byte by = k2.d();
        if (by == 0) {
            return a;
        }
