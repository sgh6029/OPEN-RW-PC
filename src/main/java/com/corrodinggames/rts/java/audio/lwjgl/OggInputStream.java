...
extends InputStream {
    ...
    public OggInputStream(InputStream inputStream, OggInputStream oggInputStream) {
        ...
        try {
            ...
            throw new AudioException(iOException);
        }
        this.init();
    }
    ...
    private boolean getPageAndPacket() {
        ...
        try {
            ...
            throw new AudioException("Failure reading Vorbis.", exception);
        }
        ...
        while (n3 < 2) {
            ...
            try {
                ...
                throw new AudioException("Failed to read Vorbis.", exception);
            }
            ...
            while (!this.endOfBitStream) {
                    ...
                    while ((n2 = this.streamState.packetout(this.packet)) != 0) {
                        ...
                        while ((n3 = this.dspState.synthesis_pcmout((float[][][])fArrayArray, nArray)) > 0) {
                            ...
                            if (this.outIndex + n4 > this.outBuffer.length) {
                                throw new AudioException("Ogg block too big to be buffered: " + n4 + ", " + (this.outBuffer.length - this.outIndex));
                            }
                ...
                if (n2 >= 0) {
                    ...
                    try {
                        ...
                        throw new AudioException("Error during Vorbis decoding.", exception);
                    }
                } else {
                    this.bytes = 0;
                }
