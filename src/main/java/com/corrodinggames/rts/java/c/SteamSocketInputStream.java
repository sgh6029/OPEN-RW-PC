...
public class SteamSocketInputStream
extends InputStream {
    ...
    public SteamSocketInputStream(SteamSocket k2) {
        this.d = k2;
    }
    ...
    public int read(byte[] byArray, int n2, int n3) throws IOException {
        ...
        while (true) {
            ...
            if (this.b) {
                this.b = false;
                com.corrodinggames.rts.gameFramework.GameEngine.log("First packet from:" + this.d.e);
            }
