...
public class SteamWorkshopManager {
   ...
   private void e() {
      if (this.j.size() != 0) {
         SteamUGCQuery var1 = this.d.createQueryUGCDetailsRequest(this.j);
         this.j.clear();
   ...
   public WorkshopItemInfo a(SteamPublishedFileID var1) {
      WorkshopItemInfo var2 = (WorkshopItemInfo)this.i.get(var1);
      if (var2 == null) {
         GameEngine.log("New ItemInfo: " + var1);
         var2 = new WorkshopItemInfo();
         var2.a = var1;
   ...
   public String b(SteamPublishedFileID var1) {
      WorkshopItemInfo var2 = this.a(var1);
      if (var2.b == 0L && !var2.c) {
   ...
   public WorkshopDownloadRequest c(SteamPublishedFileID var1) {
      Iterator var2 = this.h.iterator();

      WorkshopDownloadRequest var3;
      do {
         if (!var2.hasNext()) {
            return null;
         }

         var3 = (WorkshopDownloadRequest)var2.next();
      } while(!var3.a.equals(var1));

      return var3;
   }

   public SteamWorkshopManager(JavaSteamEngine var1) {
      this.b = var1;
      this.c = new SteamUGCCallbackHandler(this);
   }
   ...
   public boolean a(com.corrodinggames.rts.gameFramework.i.b var1) {
      if (var1.s == null) {
         ...
         String var2 = var1.p();
         if (var2 != null && !com.corrodinggames.rts.gameFramework.storage.a.i(var2)) {
            ...
            if (var11) {
               ...
               if (var13) {
                  ...
                  if (this.d.getItemDownloadInfo(var7, var29)) {
                     ...
                     var21 = var21 + " " + com.corrodinggames.rts.gameFramework.GameUtils.c(var23 * 100.0) + "%";
                  }
               }
            }
