...
import com.corrodinggames.rts.java.c.SteamSocketInputStream;
import com.corrodinggames.rts.java.c.SteamSocketOutputStream;
...
extends Socket {
    JavaSteamEngine a;
    boolean b = false;
    SteamSocketInputStream c;
    SteamSocketOutputStream d;
    SteamID e;

    public SteamSocket(JavaSteamEngine b2, SteamID steamID) {
        this.a = b2;
        this.e = steamID;
        this.c = new SteamSocketInputStream(this);
        this.d = new SteamSocketOutputStream(this);
    }
    ...
    public synchronized void close() {
        if (!this.b) {
            this.b = true;
            com.corrodinggames.rts.gameFramework.GameEngine.log("Closing steam socket");
        }
        if (this.c != null) {
            this.c.a(new byte[0]);
        }
