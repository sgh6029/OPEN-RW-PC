...
import com.corrodinggames.rts.java.d.SlickUITextureHolder;
...
public class SlickLibRocketManager
    ...
    public boolean GenerateTexture(int n2, byte[] byArray) {
        try {
            SlickUITextureHolder b2 = (SlickUITextureHolder) this.findTextureHolder(n2);
    ...
    @Override
    public void RenderGeometryPossiblyCompiled(float[] var1, float[] var2, int[] var3, int[] var4, int var5, float var6,
            float var7, LibRocket$CompiledGeometry var8) {
        try {
            if (this.debug) {
            ...
            com.corrodinggames.rts.java.d.SlickUITextureHolder var9 = null;
            if (var5 != 0) {
                var9 = (com.corrodinggames.rts.java.d.SlickUITextureHolder) this.findTextureHolder(var5);
            }
            ...
            var23.a(var6, var7);
            if (this.h && !GameUtils.a(var23, this.g)) {
                boolean var24 = true;
            ...
            if (var9 != null) {
                ...
                if (var9.h == null && var9.b) {
                    if (var9.f != null) {
                        y var18 = GameEngine.getInstance().bO;
                        this.j.pushTransform();
                        var18.i();
                        float var19 = (float) GameEngine.getInstance().bA / 1000.0F / 10.0F * 360.0F % 360.0F;
                        this.j.translate(-var6, -var7);
                        Rect var20 = new Rect(this.f.left, this.f.top, this.f.c, this.f.d);
                        this.j.setClip((Rectangle) null);
                        this.j.setWorldClip((Rectangle) null);
                        var18.a(var20);
                        PlayerTeam var21 = PlayerTeam.k(0);
                        if (var21 == null) {
                            var21 = PlayerTeam.i;
                        }

                        UnitTypeEnum.a(var9.f, var23.d(), var23.e(), var19, 3.0F, var21, var23.c() * 0.6F, var23.c(), false,
                                false, 1, (BaseUnit) null);
                        var18.p();
                        var15 = 0.0F;
                        var18.j();
                        this.j.popTransform();
    ...
    public void EnableScissorRegion(boolean bl2) {
        if (bl2) {
            this.j.setWorldClip(this.f.left, this.f.top, this.f.b(), this.f.c());
            this.h = true;
        } else {
