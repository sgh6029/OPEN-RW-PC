...
public class c
        extends l {
    public void a() {
        com.corrodinggames.rts.gameFramework.GameEngine.log("Logic boolean tests");
        ...
        j3.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j j4 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j4.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j4.cu = 44.0f;
        this.a((BaseUnit) j4, "numA=5");
        this.a((BaseUnit) j4, "numB=7");
        this.a((BaseUnit) j4, "numArrayA[0]=1");
        this.a((BaseUnit) j4, "numArrayA[1]=2");
        this.a((BaseUnit) j4, "numArrayA[2]=15");
        this.a((BaseUnit) j4, "boolArrayA[0]=true");
        this.a((BaseUnit) j4, "unitArrayA[0]=self");
        this.a((BaseUnit) j4, "numArrayA[(5)]=5");
        this.a((BaseUnit) j4, "numArrayA[5+5]=10");
        this.a((BaseUnit) j4, "numArrayA[4+4]=8");
        this.a((BaseUnit) j4, "boolArrayA[10]=true");
        this.a((BaseUnit) j4, "unitArrayA[10]=self");
        com.corrodinggames.rts.gameFramework.GameEngine.log("string: " + this.d(j4, this.b("str(memory.numArrayA)")));
        ...
        this.a((BaseUnit) j4, "numArrayA[memory.numArrayA.get(2)]=98");
        this.a((y) j4, this.b("memory.numArrayA.get(15)"), 98.0f);
        this.a((BaseUnit) j4, "numArrayA[memory.numArrayA[2]]=99");
        this.a((y) j4, this.b("memory.numArrayA.get(15)"), 99.0f);
        this.a((BaseUnit) j4, "numArrayA[((((((((6))))))))]=99");
        this.a((BaseUnit) j4, "numArrayA[((((((((memory.numArrayA[2]))))))))]=88");
        this.a((y) j4, this.b("memory.numArrayA.get(15)"), 88.0f);
        this.b((BaseUnit) j4, "numArrayA[((((((((memory.numArrayA[2])())))))]=77");
        this.b((BaseUnit) j4, "numArrayA[((((((((memory.numArrayA[2])))[)))]]))]=66");
        this.b((BaseUnit) j4, "numArrayA[a]=1");
        this.b((BaseUnit) j4, "numArrayA[0]='a'");
        this.a((BaseUnit) j4, "numArrayA[9001]=5");
        this.a((y) j4, this.b("memory.numArrayA.size"), 9002.0f);
        this.a((y) j4, this.b("memory.numArrayA.length"), 9002.0f);
        this.a((BaseUnit) j4, "numArrayA[11000]=5");
        this.a((BaseUnit) j4, "numArrayA[10000]=5");
        this.a((BaseUnit) j4, "numArrayA[10001]=6");
        this.a((BaseUnit) j4, "numArrayA[9999]=42");
        ...
        this.a((BaseUnit) j4, "numArrayA[21]=21");
        this.a((BaseUnit) j4, "numArrayA[22]=memory.numArrayA[21]");
        ...
        j5.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j5.posX = 10.0f;
        j5.cu = 55.0f;
        j5.cv = 500.0f;
        j4.bu = j5;
        this.a((BaseUnit) j5, "numA=309");
        this.a((BaseUnit) j5, "numB=409");
        j j6 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j6.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j6.posY = 5.0f;
        j6.cu = 66.0f;
        j6.cv = 1000.0f;
        j5.bv = j6;
        j j7 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j7.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j7.posX = 2.0f;
        this.a((BaseUnit) j7, "numA=99");
        this.a((BaseUnit) j7, "numB=88");
        j j8 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j8.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j8.posX = 3.0f;
        this.a((BaseUnit) j8, "numA=239");
        this.a((BaseUnit) j8, "numB=268");
        j j9 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j9.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j9.posX = 3.0f;
        j7.C(j8);
        j7.C(j9);
        j j10 = com.corrodinggames.rts.game.units.custom.l.a(false, l2);
        j10.b(com.corrodinggames.rts.game.PlayerTeam.i);
        j10.a(g.a("globalTag1, globalTag2"), false);
        j10.posX = 2.0f;
        int n2 = 50;
        com.corrodinggames.rts.gameFramework.GameEngine.log("=== logic boolean tests == (runs:" + n2 + ")");
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            this.a((y) j11, this.b("self.x+1"), j11.posX + 1.0f);
            this.a((y) j11, this.b("self.y+1"), j11.posY + 1.0f);
            this.a((y) j11, this.b("self.z+1"), j11.posZ + 1.0f);
            ...
            this.a("hp==44");
            this.a("5=44");
            if (j11 == com.corrodinggames.rts.game.PlayerTeam.i.s) {
                com.corrodinggames.rts.gameFramework.GameEngine.log("skipping for placeholderTeamUnit");
            } else {
            ...
            this.a((y) j11, this.b("self.getOffsetAbsolute(y=10).y"), j11.posY + 10.0f);
            ...
            this.a((y) j11, this.b("self.getOffsetRelative(y=10, height=5).height"), j11.posZ + 5.0f);
            this.a((y) j11, this.b("self.getOffsetAbsolute(y=10).getOffsetAbsolute(y=10).y"), j11.posY + 10.0f + 10.0f);
            this.a((y) j7, this.b("self.transporting().getOffsetAbsolute(x=5).x"), j8.posX + 5.0f);
            this.a((y) j7, this.b("self.transporting(slot=1).getOffsetAbsolute(x=5).x"), j9.posX + 5.0f);
            this.a((y) j7, this.b("self.transporting().parent.transporting().parent.id"), j7.objectId);
            this.a((y) j7, this.b("self.transporting().getOffsetAbsolute(x=memory.numA).x-memory.numA"), j8.posX);
            this.a((y) j7, this.b("self.transporting().getOffsetAbsolute(x=self.id).x-self.id"), j8.posX);
            this.a((y) j7, this.b("self.transporting().parent.transporting().getOffsetAbsolute(x=self.id).x-self.id"),
                    j8.posX);
            this.a((y) j7, this.b(
                    "self.transporting().parent.transporting().getOffsetAbsolute(x=self.id).getOffsetAbsolute().x-self.id"),
                    j8.posX);
            this.a((y) j7, this.b(
                    "self.transporting().parent.transporting().getOffsetAbsolute(x=self.id).getOffsetAbsolute(x=self.id+1).x"),
                    j8.posX + (float) j7.objectId + (float) j7.objectId + 1.0f);
            ...
            this.a((y) j11, this.b(" distanceBetween(customTarget1.customTarget2, customTarget1 ) "),
                    GameUtils.b(j5.posX, j5.posY, j6.posX, j6.posY));
            this.a((y) j11, this.b(" distanceBetweenSquared(customTarget1.customTarget2, customTarget1 ) "),
                    GameUtils.a(j5.posX, j5.posY, j6.posX, j6.posY));
            ...
            this.a((y) j11, this.b(" distanceBetween( self.getOffsetAbsolute(x=5), self.getOffsetAbsolute(x=-5) ) "),
                    10.0f);
            this.a((y) j11,
                    this.b(" distanceBetweenSquared( self.getOffsetAbsolute(x=5), self.getOffsetAbsolute(x=-5) ) "),
                    100.0f);
        ...
        com.corrodinggames.rts.gameFramework.GameEngine.log("=== logic boolean memory tests ==");
        ...
        this.a((BaseUnit) j4, "testString='(,,((', testFloat1=5, testFloat2=8, testBool1=true, testUnit1=self");
        this.a((BaseUnit) j4, "nullString=null");
        this.b((BaseUnit) j2, "testNumber1=null");
        this.b((BaseUnit) j2, "testNumber2=null");
        this.b((BaseUnit) j2, "testBool1=null");
        this.b((BaseUnit) j2, "testNumber1=self");
        this.b((BaseUnit) j2, "testBool1=5");
        com.corrodinggames.rts.gameFramework.GameEngine.log(j4.bw.debugMemory(false, true));
        ...
        this.a((BaseUnit) j4, "testFloat1=distance( 0,0,6,0 ), testFloat2=16");
        this.b(j4, this.b("memory.testFloat1==6"));
        this.b(j4, this.b("memory.testFloat2==16"));
        this.a((BaseUnit) j4, "testUnit1=self.getOffsetAbsolute(y=10), testUnit2=self.getOffsetAbsolute(y=-10)");
        com.corrodinggames.rts.gameFramework.GameEngine.log(j4.bw.debugMemory(false, true));
    ...
    public void a(String string2, boolean bl2) {
        try {
            ...
            if (runtimeException.getClass() != RuntimeException.class
                    && runtimeException.getClass() != BooleanParseException.class) {
                throw new RuntimeException(runtimeException);
            }
            if (bl2) {
                com.corrodinggames.rts.gameFramework.GameEngine
                        .d("assertCreateError: " + string2 + " error:" + runtimeException.getMessage());
            }
            return;
        }
    ...
    public void a(BaseUnit am2, String string2) {
        j j2 = (j) am2;
        VariableScope$MemoryWriter variableScope$MemoryWriter = VariableScope.createMemoryWriter(string2, j2.x,
                "testsection", "testkey");
        variableScope$MemoryWriter.writeToUnit(j2);
    }

    public void b(BaseUnit am2, String string2) {
        try {
            j j2 = (j) am2;
            VariableScope$MemoryWriter variableScope$MemoryWriter = VariableScope.createMemoryWriter(string2, j2.x,
                    "testsection", "testkey");
    ...
    public LogicBoolean b(String string2, boolean bl2) {
        try {
            ...
            throw new RuntimeException("Error: " + runtimeException.getMessage() + " parsing [" + string2 + "]",
                    runtimeException);
        }
    }
    ...
    public void a(y y2, LogicBoolean logicBoolean) {
        if (logicBoolean.getReturnType() != LogicBoolean$ReturnType.bool) {
            throw new RuntimeException(
                    "Asset assertBooleanTrue type ==" + (Object) ((Object) logicBoolean.getReturnType()));
        }
    ...
    public void b(y y2, LogicBoolean logicBoolean) {
        ...
        if (!bl2) {
            throw new RuntimeException(
                    "Asset assertBooleanTrue failed, got false for: " + logicBoolean.getMatchFailReasonForPlayer(y2));
        }
    }
    ...
    public void c(y y2, LogicBoolean logicBoolean) {
        if (logicBoolean.getReturnType() != LogicBoolean$ReturnType.bool) {
            throw new RuntimeException(
                    "Asset assertBooleanFalse type ==" + (Object) ((Object) logicBoolean.getReturnType()));
        }
    ...
    public void a(y y2, LogicBoolean logicBoolean, float f2) {
        if (logicBoolean.getReturnType() != LogicBoolean$ReturnType.number) {
            throw new RuntimeException(
                    "Asset assertBooleanNumber type ==" + (Object) ((Object) logicBoolean.getReturnType()));
        }
        float f3 = logicBoolean.readNumber(y2);
        if (GameUtils.c(f3 - f2) > 0.001f) {
            throw new RuntimeException(
                    "Asset failed (float):" + f3 + "!=" + f2 + " for: " + logicBoolean.getMatchFailReasonForPlayer(y2));
        }
    }
    ...
    public String d(y y2, LogicBoolean logicBoolean) {
        if (logicBoolean.getReturnType() != LogicBoolean$ReturnType.string) {
            throw new RuntimeException(
                    "Asset assertBooleanString type ==" + (Object) ((Object) logicBoolean.getReturnType()));
        }
    ...
    public void a(y y2, LogicBoolean logicBoolean, BaseUnit am2) {
        if (logicBoolean.getReturnType() != LogicBoolean$ReturnType.unit) {
            throw new RuntimeException(
                    "Asset assertBooleanUnit type ==" + (Object) ((Object) logicBoolean.getReturnType()));
        }
        BaseUnit am3 = logicBoolean.readUnit(y2);
        if (am3 != am2) {
            com.corrodinggames.rts.gameFramework.GameEngine.log("class: " + logicBoolean.getClass().getName());
            throw new RuntimeException("assertBooleanUnit failed:" + BaseUnit.A(am3) + "!=" + BaseUnit.A(am2) + " for: "
                    + logicBoolean.getMatchFailReasonForPlayer(y2));
        }
    }
}
