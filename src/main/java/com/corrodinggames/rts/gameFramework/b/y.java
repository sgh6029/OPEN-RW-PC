...
import com.corrodinggames.rts.gameFramework.b.VertexBuffer;
import com.corrodinggames.rts.gameFramework.b.Texture;
import com.corrodinggames.rts.gameFramework.b.TextureShader;
...
public class y {
    ...
    public void a(Texture b2, RectF rectF, RectF rectF2, float[] fArray) {
        if (this.e == this.d) {
            this.c();
        }
        this.a(b2);
