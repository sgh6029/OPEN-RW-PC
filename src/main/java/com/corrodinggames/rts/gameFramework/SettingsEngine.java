...
public class SettingsEngine {
    ...
    public String getValueDynamic(String string2) {
        Object object;
        try {
            Field field = (Field)this.settingFields.get(string2);
            if (field == null) {
    ...
    public boolean saveToFileSystem() {
        ...
        try {
            ...
            for (Object object : l2.bT.al) {
                if (!((KeyBinding)object).b || ((KeyBinding)object).d()) continue;
                string2 = "";
                string2 = string2 + ((KeyBinding)object).e();
                String string3 = l2.bT.a((KeyBinding)object);
            ...
            GameEngine.getInstance().a("Failed to save preferences, IO error", 1);
            return false;
        }
        return true;
    }
    ...
    public void loadFromFileSystem() {
        ...
        if (!file.exists()) {
            GameEngine.log("preferences not found, not loading (" + string2 + ")");
            return;
        }
        ...
        try {
            String string4;
            String string5;
            IniFile ab2 = new IniFile(string2);
            for (Map.Entry object : ((Set<Map.Entry>)this.settingFields.entrySet()) ){
                string5 = (String)object.getKey();
                string4 = ab2.b(string3, string5, (String)null);
                if (GameEngine.isDebugVersionStatic2) {
                    GameEngine.log(string5 + "= " + string4);
                }
                if (string4 == null || "".equals(string4)) continue;
                if (string5.startsWith("key.")) {
                    string5 = string5.replace("key.", "");
                    GameEngine.log("loading keybind:" + string5);
                    l2.bT.a(string5, string4);
                    continue;
                }
                this.setValueDynamic(string5, string4);
            }
            for (KeyBinding ad2 : l2.bT.al) {
                if (!ad2.b || ad2.d() || (string4 = ab2.b("keys", string5 = ad2.e(), (String)null)) == null || "".equals(string4)) continue;
                l2.bT.a(string5, string4);
            }
        }
        catch (IOException iOException) {
            iOException.printStackTrace();
            GameEngine.getInstance().a("Failed to load preferences, IO error", 1);
        }
    }
    ...
    private SettingsEngine(Context context) {
        ...
        for (Field field : fieldArray = this.getClass().getFields()) {
            ...
            if (this.settingFields.get(string2) != null) {
                GameEngine.log("SettingsEngine: fields: " + string2 + " already exists");
            }
            if (GameEngine.isDebugVersionStatic2) {
                GameEngine.log("SettingsEngine: field:" + string2);
            }
            this.settingFields.put(string2, field);
        }
        if (!GameEngine.isPausedStatic2) {
        ...
        this.mouseSupport = this.getBooleanPref("mouseSupport", !GameEngine.d(context));
    ...
    public boolean loadMainExternalFolder(boolean bl2) {
        ...
        GameEngine l2 = GameEngine.getInstance();
        if (bl2 && l2.isExtraSafeModeEnabled()) {
        ...
        GameEngine.log("External saf link: " + string2);
        GameEngine.log("External saf shown path: " + string3);
        GameEngine.log("External saf extra: " + string4);
        try {
            Uri uri = Uri.parse((String)string2);
            boolean bl3 = false;
            String string5 = null;
            String string6 = a.a(uri, true);
            GameEngine.log("safVirualPathBase: " + string6);
            if (string6 == null) {
                GameEngine.log("createSAFLink failed for uri: " + uri);
                bl3 = true;
            } else {
                string5 = string6 + string4;
                GameEngine.log("safVirualPath: " + string5);
                if (!com.corrodinggames.rts.gameFramework.storage.a.f(string5)) {
                    GameEngine.log("isDirectory failed for: " + string5);
                    bl3 = true;
                }
            }
            if (bl3) {
                ...
                com.corrodinggames.rts.gameFramework.i.a.a = com.corrodinggames.rts.gameFramework.i.a.a + string7;
                com.corrodinggames.rts.gameFramework.i.a.b = string7;
                return false;
            }
            GameEngine.log("Using external path");
            l2.bQ.externalSAFWorking = true;
            com.corrodinggames.rts.gameFramework.storage.a.d = string5;
            return true;
        }
