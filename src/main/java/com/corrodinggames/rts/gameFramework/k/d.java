...
extends j {
    ...
    final PriorityQueue<n> q = new PriorityQueue<n>();
    ...
    private void d() {
        ...
        for (int i2 = 0; i2 <= this.n; ++i2) {
            n n2 = this.o[i2];
            if (n2 == null) {
                com.corrodinggames.rts.gameFramework.GameEngine.log("n:" + i2);
                com.corrodinggames.rts.gameFramework.GameEngine.log("lowestBufferLastIndex:" + this.n);
