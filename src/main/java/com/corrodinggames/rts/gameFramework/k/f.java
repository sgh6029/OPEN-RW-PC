    ...
    public void d() {
        ...
        for (int i2 = n5; i2 < n3 + 1; ++i2) {
            for (int i3 = n4; i3 < n2 + 1; ++i3) {
                com.corrodinggames.rts.game.b.MapTile g2 = e2.a(i2, i3);
                if (g2 == null) continue;
                int n6 = i2 * b2.n;
                int n7 = i3 * b2.o;
                ...
                try {
                    l2.bO.a(f6, f7, f6 + (float)(com.corrodinggames.rts.gameFramework.k.f.d.x * (b2.n - 3)) + 1.0f, f7 + (float)(com.corrodinggames.rts.gameFramework.k.f.d.b * (b2.o - 3)) + 1.0f, c);
