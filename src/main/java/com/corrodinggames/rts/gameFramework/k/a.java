...
RandomAccess {
    ...
    public boolean contains(Object object) {
        ...
        if (object != null) {
            for (int i2 = 0; i2 < n2; ++i2) {
                if (!object.equals(nArray[i2])) continue;
                return true;
            }
        } else {
    ...
    public boolean remove(Object object) {
        ...
        if (object != null) {
            for (int i2 = 0; i2 < n2; ++i2) {
                if (!object.equals(nArray[i2])) continue;
                System.arraycopy(nArray, i2 + 1, nArray, i2, --n2 - i2);
                nArray[n2] = null;
                this.b = n2;
                ++this.modCount;
                return true;
            ...
            for (int i3 = 0; i3 < n2; ++i3) {
                if (nArray[i3] != null) continue;
                System.arraycopy(nArray, i3 + 1, nArray, i3, --n2 - i3);
                nArray[n2] = null;
                this.b = n2;
                ++this.modCount;
                return true;
    ...
    public boolean equals(Object object) {
        ...
        if (list instanceof RandomAccess) {
            for (int i2 = 0; i2 < n2; ++i2) {
                ...
                if (!(n3 == null ? e2 != null : !n3.equals(e2))) continue;
                return false;
            }
        } else {
            ...
            for (int i3 = 0; i3 < n2; ++i3) {
                ...
                if (!(n4 == null ? e3 != null : !n4.equals(e3))) continue;
                return false;
            }
        }
        return true;
