...
import com.corrodinggames.rts.gameFramework.sound.b;
import com.corrodinggames.rts.gameFramework.sound.c;
import com.corrodinggames.rts.gameFramework.sound.d;
...
extends h {
    ...
    public i a(String string2, AssetInputStream j2, boolean bl2) {
        ...
        block16: {
            ...
            if (!j2.a()) {
                try {
                    object = com.corrodinggames.rts.gameFramework.storage.a.a(this.f, "audio", "ogg");
                    try {
