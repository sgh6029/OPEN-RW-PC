...
public class m {
    ...
    public synchronized n a(String string2, String string3) {
        ...
        if (string2 != null && !string2.equals("") && !l2.bQ.showPlayerChatInGame) {
            if (!this.e) {
                this.e = true;
    ...
    public synchronized int a(float f2, int n2) {
        ...
        boolean bl2 = l2.isNetworkGameActive();
        for (int i2 = this.f.size() - 1; i2 >= 0; --i2) {
            n n5 = (n)this.f.get(i2);
            if (!n5.b()) continue;
            String string2 = n5.a == null || n5.a.equals("") ? n5.b : n5.a + ": " + n5.b;
            if (bl2) {
