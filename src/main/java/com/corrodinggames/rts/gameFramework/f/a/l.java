...
public abstract class l {
    ...
    m x = com.corrodinggames.rts.gameFramework.f.a.m.vertical;
    float y;
    float z;
    ...
    public y d() {
        return com.corrodinggames.rts.gameFramework.GameEngine.getInstance().bO;
    }
    ...
    public RectF a(RectF rectF) {
        com.corrodinggames.rts.gameFramework.f.a.l.A.x = this.g;
        com.corrodinggames.rts.gameFramework.f.a.l.A.b = this.h;
        if (this.v != null) {
            this.v.a(A);
        }
        rectF.left = 0.0f + com.corrodinggames.rts.gameFramework.f.a.l.A.x;
        rectF.b = 0.0f + com.corrodinggames.rts.gameFramework.f.a.l.A.b;
        rectF.c = 0.0f + this.i + com.corrodinggames.rts.gameFramework.f.a.l.A.x;
        rectF.d = 0.0f + this.j + com.corrodinggames.rts.gameFramework.f.a.l.A.b;
        return rectF;
    }

    public void b() {
        for (l l2 : ((List<l>) this.w)) {
            l2.b();
        }
        this.y = 0.0f;
        this.z = 0.0f;
        if (this.x != com.corrodinggames.rts.gameFramework.f.a.m.none) {
            if (this.x == com.corrodinggames.rts.gameFramework.f.a.m.vertical) {
                float f2 = 0.0f;
                float f3 = 0.0f;
                for (l l3 : ((List<l>) this.w)) {
                    if (l3.i > f2) {
                        f2 = l3.g();
                    }
                    f3 += l3.h();
            ...
            } else if (this.x == com.corrodinggames.rts.gameFramework.f.a.m.horizontal) {
                float f4 = 0.0f;
                float f5 = 0.0f;
                for (l l4 : ((List<l>) this.w)) {
                    if (l4.j > f4) {
                        f4 = l4.h();
                    }
                    f5 += l4.g();
    ...
    public void f() {
        ...
        this.a(com.corrodinggames.rts.gameFramework.f.a.l.A.x, com.corrodinggames.rts.gameFramework.f.a.l.A.b);
        if (this.w.size() > 0) {
            for (l l2 : ((List<l>) this.w)) {
                l2.f();
            }
    ...
    public boolean a(c c2) {
        if (c2.a() && this.c(c2)) {
            com.corrodinggames.rts.gameFramework.GameEngine.log("UI click " + this.a());
            if (this.B != null) {
                return this.B.a(c2);
            }
            return false;
