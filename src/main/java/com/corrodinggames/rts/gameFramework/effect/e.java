...
public final class e {
    ...
    public boolean o;
    public boolean p;
    public h q = com.corrodinggames.rts.gameFramework.effect.h.verylow;
    public boolean r;
    public boolean s;
    public float t;
    public boolean u;
    ...
    public ag at = com.corrodinggames.rts.gameFramework.effect.e.a();
    public float au;
    public int av;
    public boolean aw;
    ...
    public void b() {
        if (this.o) {
            this.o = false;
            --this.ay.a;
            com.corrodinggames.rts.gameFramework.effect.c.h = true;
    ...
    public void c() {
        ...
        this.q = com.corrodinggames.rts.gameFramework.effect.h.verylow;
        this.b = null;
        this.c = false;
        this.d = false;
        this.e = true;
    ...
    public boolean a(GameEngine l2, boolean bl2) {
        ag ag2;
        LightingColorFilter lightingColorFilter;
        float f2;
        int n2;
        float f3;
        Rect rect = com.corrodinggames.rts.gameFramework.effect.c.o;
        RectF rectF = com.corrodinggames.rts.gameFramework.effect.c.n;
        if (this.U > 0.0f) {
            return false;
        }
        if (bl2 && this.K < 1.0f) {
        ...
        g g2 = this.a.imageStrip != null ? this.a.imageStrip : com.corrodinggames.rts.gameFramework.effect.c.s[this.aq];
        if (!g2.k) {
            int n3 = this.ap;
            com.corrodinggames.rts.gameFramework.effect.e.a(n3, g2, rect);
        } else {
        ...
        rectF.a(pointF.x, pointF.b, pointF.x + (float)rect.b(), pointF.b + (float)rect.c());
        if (this.an) {
        ...
        if (this.S != 0.0f) {
            float f6 = com.corrodinggames.rts.gameFramework.GameUtils.j((this.W - this.V) / this.T * 360.0f) * this.S;
            rectF.a(0.0f, f6);
        }
        ...
        if (bl6 && com.corrodinggames.rts.gameFramework.GameEngine.at() && !bl2 && this.B == null) {
        ...
        if (this.ar == 3) {
            if (com.corrodinggames.rts.gameFramework.effect.c.k == null) {
                com.corrodinggames.rts.gameFramework.GameEngine.log("Loading displacement shader");
                try {
                    com.corrodinggames.rts.gameFramework.effect.c.k = new ShaderProgram("assets/shaders/post_displacement.frag");
                }
            ...
            if (this.ay.l != null) {
                ShaderProgram ae2 = com.corrodinggames.rts.gameFramework.effect.c.k;
        ...
        if (this.L) {
            ...
            y2.a(rectF.left, rectF.b, pointF.x - l2.cw, pointF.b - l2.cx, this.ay.w);
        } else if (bl2) {
            if (g2.j != null) {
    ...
    static {
        for (int i2 = 0; i2 < ax.length; ++i2) {
            com.corrodinggames.rts.gameFramework.effect.e.ax[i2] = com.corrodinggames.rts.gameFramework.effect.e.a();
