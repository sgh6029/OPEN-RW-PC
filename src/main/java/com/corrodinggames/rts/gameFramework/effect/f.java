...
extends GGameObject {
    ...
    public static void b() {
        c c2 = com.corrodinggames.rts.gameFramework.GameEngine.getInstance().bR;
        e e2 = new e(c2);
        com.corrodinggames.rts.gameFramework.effect.f.a(e2, false);
        e2.aq = 18;
        e2.t = 15.0f;
        v = e2;
        e2 = new e(c2);
        com.corrodinggames.rts.gameFramework.effect.f.b(e2, false);
        w = e2;
    }
    ...
    public static void a(e e2, boolean bl2) {
        e2.c();
        e2.aq = 5;
        e2.ap = bl2 ? com.corrodinggames.rts.gameFramework.GameUtils.a(0, 1) : 0;
        e2.Y = 0.0f;
        e2.an = true;
        e2.P = 0.1f;
        e2.R = 0.5f;
        ...
        e2.G = 0.4f;
        e2.F = 1.5f;
        e2.g = com.corrodinggames.rts.gameFramework.effect.e.k;
    }

    public static void b(e e2, boolean bl2) {
        e2.c();
        e2.aq = 7;
        e2.ap = bl2 ? com.corrodinggames.rts.gameFramework.GameUtils.a(0, 3) : 0;
        e2.Y = 0.0f;
        e2.an = true;
        e2.P = 0.0f;
        e2.R = 0.2f;
        ...
        e2.as = false;
        e2.ar = (short)2;
        e2.g = com.corrodinggames.rts.gameFramework.effect.e.n;
    }

    public static f a(float f2, float f3) {
        f f4 = com.corrodinggames.rts.gameFramework.effect.f.a(f2, f3, v);
        f4.a = 280.0f;
        f4.f = 10.0f;
        f4.c = 10.0f;
        f4.m = 0.03f;
        ...
        f4.p = 6.0f;
        f4.q = 6.0f;
        f4.s = com.corrodinggames.rts.gameFramework.effect.h.verylow;
        f4.r = 180.0f;
        f4.j = -16777216;
        return f4;
    }
    ...
    public static f b(float f2, float f3) {
        f f4 = com.corrodinggames.rts.gameFramework.effect.f.a(f2, f3, w);
        f4.a = 330.0f;
        f4.f = 10.0f;
        f4.c = 10.0f;
        f4.m = 0.1f;
    ...
    public static f a(float f2, float f3, e e2) {
        ...
        if (e2 == null) {
            f4.i = new e(c2);
            com.corrodinggames.rts.gameFramework.GameEngine.b("Error: Emitter create srcEffect==null");
        }
        return f4;
    }
    ...
    public boolean c() {
        ...
        return l2.cP.b(this.posX, this.posY);
    }
        ...
        if (this.b) {
            ...
            if (this.c > this.f) {
                ...
                if (this.d > this.g) {
                    ...
                    if ((this.u || this.c()) && (e2 = this.x.b(this.posX, this.posY, 0.0f, com.corrodinggames.rts.gameFramework.effect.d.custom, false, this.s)) != null) {
                        e2.a(this.i);
