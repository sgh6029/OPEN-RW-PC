...
implements Runnable {
    ...
    ReplayWriter(ReplayEngine ba2) {
        this.k = ba2;
    }

    public synchronized void a(ReplayCommand bd2) {
        if (this.h) {
    ...
    public void run() {
        ...
        while (this.a) {
            if (this.i.size() > 0) {
                ReplayCommand bd2 = (ReplayCommand)this.i.remove();
                try {
                    if (bd2.e != null) {
                        this.k.J.e("rc");
                        this.k.J.a(bd2.a);
                    ...
                    GameEngine l2 = GameEngine.getInstance();
                    GameEngine.a("Replay error", (Throwable)iOException);
        ...
        try {
            ...
            this.k.J.a(this.d);
            this.k.J.a(this.e);
            this.k.J.writeUTF("{frames:" + this.b + ",time:" + this.c + ",commandCount:" + this.d + ",resyncCount:" + this.e + "}");
