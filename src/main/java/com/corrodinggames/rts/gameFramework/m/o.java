...
extends u {
    ...
    public void a(float f2, float f3, float f4, Paint paint) {
        ...
        this.a(p.t, Float.valueOf(f2), Float.valueOf(f3), Float.valueOf(f4), (Object)paint);
    }
    ...
    public void a(String string2, float f2, float f3, Paint paint) {
        ...
        this.a(p.R, string2, Float.valueOf(f2), Float.valueOf(f3), paint, null, null, null, null);
    }
