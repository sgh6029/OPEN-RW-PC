...
import com.corrodinggames.rts.gameFramework.m.OpenGLGraphicsRenderer;
...
implements y {
    ...
    @Override
    public void b() {
        this.s = new ad(this.a(com.corrodinggames.rts.R.drawable.error_outmem));
    }
    ...
    private void a(Paint paint, Texture_M e2) {
    ...
    public boolean c() {
        ...
        return this.y instanceof OpenGLGraphicsRenderer;
    }

    private void a(Paint paint, boolean bl2, String string2, Texture_M e2) {
        this.t();
    }
    ...
    public Texture_M a(int n2, boolean bl2) {
        ...
        options.inPreferredConfig = bl2 ? Bitmap.Config.ARGB_8888 : Bitmap.Config.RGB_565;
    ...
    public Texture_M a(InputStream inputStream, boolean bl2) {
        ...
        if (bitmap == null) {
            com.corrodinggames.rts.gameFramework.GameEngine.g("Could not load image from steam");
            return null;
        }
        Log.d("RustedWarfare", "load a:" + bl2 + " as " + (Object)((Object)bitmap.getConfig()));
        return this.a(bitmap);
    }

    public Texture_M a(Bitmap bitmap) {
    ...
    public Texture_M b(int n2, int n3, boolean bl2) {
        Bitmap bitmap;
        Bitmap.Config bitmap$Config = bl2 ? Bitmap.Config.ARGB_8888 : Bitmap.Config.ARGB_8888;
        try {
            bitmap = Bitmap.createBitmap(n2, n3, bitmap$Config);
            if (bitmap != null && !bl2 && bitmap$Config == Bitmap.Config.ARGB_8888 && Build.VERSION.SDK_INT >= 12) {
    ...
    public void a(boolean bl2) {
        ...
        if (!bl2) {
            this.i.setPixels(c, 0, n2, 0, 0, n2, n3);
        }
        d = this.i;
    }
    ...
    public void a(String string2, float f2, float f3, Paint paint, Paint paint2, float f4) {
        ...
        com.corrodinggames.rts.gameFramework.GameUtils.a(t, f4);
        this.b(paint2);
        this.y.a(t, paint2);
        this.a(string2, com.corrodinggames.rts.gameFramework.m.x.u.left + f4 / 2.0f, com.corrodinggames.rts.gameFramework.m.x.u.d - f4 / 2.0f, paint);
    }
    ...
    public void g() {
        if (this.v.size() > 0) {
            ...
            synchronized (m2) {
                for (ShaderProgram ae2 : ((List<ShaderProgram>)this.v) ){
                    this.y.a(ae2);
                }
                this.v.clear();
            }
    ...
    public void c(Rect rect, Paint paint) {
        this.n.a(rect.left, rect.top, rect.left + rect.c, rect.top + rect.d);
        this.b(paint);
    ...
    public void a(Rect rect) {
        if (this.i != null) {
            rect = new Rect(rect);
            int n2 = this.i.getHeight() - this.l;
        }
        this.d().a(rect);
    }
    ...
    public int b(String string2, Paint paint) {
        ...
        return com.corrodinggames.rts.gameFramework.m.x.w.left + w.b();
    }
