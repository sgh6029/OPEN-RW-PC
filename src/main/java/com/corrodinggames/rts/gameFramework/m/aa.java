...
public final class aa {
    ...
    public static final Bitmap a(Texture_M e2) {
        return e2.b();
    }
    ...
    public static ab a(float f2, float f3, boolean bl2, y y2) {
        ...
        if (f[n8] != null) {
            if (aa.f[n8].b != n2) {
                GameEngine.log("Mismatch on index: " + n8 + " size:" + n2);
            }
            return f[n8];
        }
        ab ab2 = new ab();
    ...
    public static Texture_M a(int n2, int n3, boolean bl2, y y2) {
        Paint paint = new Paint();
        paint.b(-1);
        paint.a(bl2 ? Paint$Style.a : Paint$Style.b);
        paint.a((float)n3);
        int n4 = n2;
        Texture_M e2 = y2.b(n4 * 2 + 4, n4 * 2 + 4, true);
        y y3 = y2.b(e2);
        try {
    ...
    public static void a(y y2, float f2, float f3, float f4, int n2, Paint paint, Rect rect) {
        if (a != n2) {
            ...
            c = com.corrodinggames.rts.gameFramework.GameUtils.k(b);
            d = com.corrodinggames.rts.gameFramework.GameUtils.j(b);
        }
        float f5 = c;
        float f6 = d;
        int n3 = (int)(b * f4 * 0.5f);
        int n4 = n3 + 50;
        aa.e.left = rect.left - n4;
        aa.e.top = rect.top - n4;
        aa.e.c = rect.c + n4;
        aa.e.d = rect.d + n4;
        float f7 = f4;
        float f8 = 0.0f;
    ...
    public static void a(y y2, Texture_M e2, Rect rect, Paint paint, int n2, int n3, int n4, int n5) {
        int n6 = e2.m();
        int n7 = e2.l();
        if (n2 != 0 && (n2 %= e2.m()) < 0) {
            n2 += e2.m();
        ...
        int n11 = 0;
        for (int i2 = rect.left - n2; i2 < rect.c; i2 += n9) {
            while (n8 < rect.d) {
                int n12;
                int n13;
                if (++n11 > 2000) {
                ...
                int n15 = aa.i.left - rect.left;
                if (n15 < 0) {
                    aa.h.left -= n15;
                    aa.i.left -= n15;
                }
                if ((n12 = aa.i.top - rect.top) < 0) {
                    aa.h.top -= n12;
                    aa.i.top -= n12;
                }
                try {
    ...
    public static void a(y y2, Texture_M e2, RectF rectF, Paint paint, float f2, float f3, int n2, int n3) {
        int n4 = e2.m();
        int n5 = e2.l();
        ...
        for (float f5 = rectF.left - f2; f5 < rectF.c; f5 += (float)n7) {
            while (f4 < rectF.d) {
                float f6;
                float f7;
                if (++n6 > 2000) {
                ...
                float f9 = aa.j.left - rectF.left;
                if (f9 < 0.0f) {
                    aa.h.left = (int)((float)aa.h.left - f9);
                    aa.j.left -= f9;
                }
                if ((f6 = aa.j.b - rectF.b) < 0.0f) {
                    aa.h.top = (int)((float)aa.h.top - f6);
                    aa.j.b -= f6;
                }
                try {
                    y2.a(e2, h, j, paint);
    ...
    public static void a(y y2, Texture_M e2, Rect rect, Rect rect2, Paint paint, int n2, int n3, int n4, int n5, float f2) {
        int n6 = rect.b();
        int n7 = rect.c();
        if (n2 != 0 && (n2 %= n6) < 0) {
            n2 += n6;
        ...
        while (n8 < rect2.c) {
            while (n9 < rect2.d) {
                ...
                int n24 = aa.i.left - rect2.left;
                if (n24 < 0) {
                    aa.h.left -= n24;
                    aa.i.left -= n24;
                }
                if ((n19 = aa.i.top - rect2.top) < 0) {
                    aa.h.top -= n19;
                    aa.i.top -= n19;
                }
                try {
