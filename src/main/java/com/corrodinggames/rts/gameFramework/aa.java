...
public class aa
        ...
        while (!m3.isEmpty()) {
            ...
            for (int i2 = 0; i2 < n5; ++i2) {
                ...
                for (int i3 = 0; i3 < m3.a; ++i3) {
                    ...
                    float f5 = y2.posX + pointF3.x;
                    float f6 = y2.posY + pointF3.b;
                    float f7 = GameUtils.a(y4.posX, y4.posY, f5, f6);
                    if (f4 != -1.0f && !(f7 < f4))
                        continue;
                    f4 = f7;
                    pointF2 = pointF3;
    ...
    public void a(m m2, y y2) {
        ...
        while (true) {
            y y3 = null;
            for (y y4 : ((List<y>) m2)) {
                if (y4.ad != y2 || !(y4.ao > 0.0f) || y3 != null && !(y4.ao > y3.ao) || !y4.aj || !(y4.ao > 100.0f))
                    continue;
                y3 = y4;
            }
            if (y3 == null)
            ...
            float f2 = 0.0f;
            y y5 = y3;
            int n2 = GameUtils.a((int) y5.ao);
            for (y y6 : ((List<y>) m2)) {
                if (y6.ad != y2 || !(y6.ao > 0.0f) || y6 == y5)
                    continue;
                int n3 = GameUtils.a((int) y6.ao) + n2;
                int n4 = 0;
                n4 += GameUtils.c(y5.posX, y5.posY, y2.posX + y6.ak, y2.posY + y6.al);
                float f3 = (n4 += GameUtils.c(y6.posX, y6.posY, y2.posX + y5.ak, y2.posY + y5.al)) - n3;
                if (!(f3 < f2))
                    continue;
                f2 = f3;
                object = y6;
            ...
            y5.ak = ((y) object).ak;
            y5.al = ((y) object).al;
            y5.ao = GameUtils.a(y5.posX, y5.posY, y2.posX + y5.ak, y2.posY + y5.al);
            ((y) object).ak = f4;
            ((y) object).al = f5;
            ((y) object).ao = GameUtils.a(((y) object).posX, ((y) object).posY, y2.posX + ((y) object).ak,
                    y2.posY + ((y) object).al);
        }
    }
    ...
    public m a(int n2, float f2, float f3) {
        ...
        float f5 = GameUtils.k(f3);
        float f6 = GameUtils.j(f3);
